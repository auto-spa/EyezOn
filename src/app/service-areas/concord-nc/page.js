...
const sections = [
  {
    ...
    title: "Concord Comfort: Car Interior Cleaning Specialists",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Bring back the beauty and comfort of your ride with our car interior
          cleaning services in Concord. Our professional crew focuses on
          cleaning the indoors of your ride, ensuring each inch of your
          vehicle’s interior is perfectly neat and clean.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          Using superior techniques and sustainable products, we cast off dust,
          stains, and odors from your car’s upholstery, leaving it looking and
          smelling like new. Whether you are managing spills, puppy hair, or
          common wear and tear, our auto upholstery cleaning services in Concord
          are customized to satisfy your needs.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          From deep cleaning carpets and fabric to conditioning leather-based
          surfaces, we pay careful attention to details to make certain your
          car’s indoors is comfortable and inviting. Discover the difference our
          interior car detailing services in Concord can make in your driving
          experience. With our professional services, you can experience a
          smooth, clean, and snug riding experience every time you hit the road
          in your car.
        </div>
      </div>
    ),
    imgSrc: "/images/Concord-NC.jpg",
  },
];
