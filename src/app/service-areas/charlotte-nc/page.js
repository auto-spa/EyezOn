...
const sections = [
  {
    ...
    title: "Deep Cleanliness at Charlotte's Car Spa",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Searching for a way to restore your vehicle’s sparkle in Charlotte,
          NC? Find excellent detail shops near Charlotte that specialize in
          comprehensive car care and thorough cleaning services. Our team of
          expert detailers is dedicated to rejuvenating your car’s flawless
          state, both internally and externally.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          Our professional technicians use advanced strategies and superb
          products to offer your vehicle the right care it deserves, paying very
          close attention to each element. Whether it’s getting rid of tough
          stains from fixtures, bringing back the shine of your car’s exterior,
          or giving thorough deep cleaning, we have what you need.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          Our full-service car detailing provides customized packages designed
          to fulfill all of your requirements. Receive exceptional results and
          unparalleled customer service conveniently. Bid farewell to dust,
          dirt, and blemishes. Rely on our expert staff to provide exceptional
          results, ensuring your car appears and feels fresh and new. Discover
          our variety of services and spoil your car with our car deep cleaning
          services in Charlotte.
        </div>
      </div>
    ),
    imgSrc: "/images/Charlotte-NC.webp",
  },
];
