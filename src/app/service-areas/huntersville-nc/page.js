...
const sections = [
  {
    ...
    title: "Sail with Sparkle, Huntersville's Boat Detailing",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Try our superior marine detailing services in Huntersville, NC for the
          ultimate marine luxury experience. Our group of experienced experts
          focuses on thorough boat cleaning and detailing, guaranteeing that
          your boat stays in top condition throughout the entire year. From
          detailed yacht cleaning to thorough boat interior cleaning, we provide
          extensive services customized to fit the specific requirements of boat
          lovers in Huntersville and surrounding areas. By using innovative
          tools and top-quality materials, we ensure outstanding results that
          are far better than what you expect.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          Our skilled technicians are going to improve your marine experience,
          whether you’re getting ready for a holiday on the lake or showing off
          your yacht’s beauty on the sea. Rely on us to protect your investment
          and maintain the look of your boat, both inside and out with our yacht
          detailing in Huntersville. Get the best boat interior cleaning in
          Huntersville, NC, to enhance your boating adventure to a higher level
          and see the change for yourself.
        </div>
      </div>
    ),
    imgSrc: "/images/Huntersville-NC.jpg",
  },
];
    ...
    <div>
      <div className="relative min-h-[60vh] bg-gradient-to-r from-purple-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          ...
          Car Detailing Services Huntersville, NC
          </h1>
