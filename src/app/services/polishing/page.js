...
const sections = [
  {
    ...
    title: "Polish to Perfection, Shine Never Seen Before",
    description: (
      <p style={{ whiteSpace: "pre-line" }}>
        We invite you to experience our expert car polishing services in
        Charlotte, where we are committed to restoring your vehicle’s appearance
        to its highest quality. Our expert team provides customized solutions to
        remove different flaws and improve the overall gloss of your vehicle.
        Discover the powerful impact of our car polishing, where we use advanced
        methods and the best products to remove swirl marks and scratches,
        resulting in a shining and showroom-quality paint job. <br />
        Our vehicle paint polishing services in Charlotte offer personalized
        care to restore your vehicle’s paint and achieve a flawless finish for
        those looking for complete care. Furthermore, our car buffing and
        polishing services in Charlotte are aimed at addressing small
        imperfections, showcasing the original shine and brightness of your
        vehicle’s outer part. You can expect us to surpass your expectations
        with extra attention to each element and willpower to excellence. Allow
        our skilled services to enhance the look of your car.
      </p>
    ),
    imgSrc: "/images/polishing.png",
  },
];
...
<div className="relative z-10 p-10 w-full text-center">
  ...
  >
    Polishing Service Charlotte, NC
  </h1>
